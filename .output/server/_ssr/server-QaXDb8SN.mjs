...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bl-442_k.mjs");
...
const manifest = {
  "500732ef2651da76c4b9a7818243d2554bc8b3c8555b748ca6079e9445e99c49": {
    functionName: "chatWithAssistant_createServerFn_handler",
    importer: () => import("./chat.functions-Ds1S2DsZ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BXvcFo5v.mjs"),
    import("./start-BuYjSFvz.mjs"),
